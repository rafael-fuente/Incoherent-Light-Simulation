...
double_slit_simulation(light_source = Incoherent_rectangular_source(number_of_dipoles = 10000, 
                       ...
                       total_femtoseconds = 500,
                       number_of_frames = 50,
                       complex_average = False,
                       simulation_name = "simulation_partially_incoherent_femtoseconds.h5")

visualize(simulation_name = "simulation_partially_incoherent_femtoseconds.h5",
